...
#define STRING_CONFIG_H_AUTHOR "(eXploitz, BIQU B1 BLTouch)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 96 }     // Default e-step values
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 412.37 }   // BMG extruder clone
/**
...
#define PROBING_MARGIN 4 // Default 10
